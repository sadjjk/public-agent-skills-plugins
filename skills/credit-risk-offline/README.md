...
- **分箱图集成** — 分箱结果直接出图，BAD_RATE/LIFT/KS/AUC 一张图全都有
...
| ![标签异常诊断及修复](imgs/sample/03-标签异常诊断及修复.jpg) <br/> **标签异常诊断及修复** — 诊断并修复 label 异常 | ![样本报告](imgs/sample/04-样本报告.jpg) <br/> **样本报告** — 样本分析报告 | ![样本报告举例](imgs/sample/05-样本报告举例.jpg) <br/> **样本报告举例** — 开头预览，完整版见[报告样例](docs/样本生成报告样例.md) |
...
| ![特征筛选报告样例](imgs/feature/05-特征筛选报告样例.jpg) <br/> **特征筛选报告** — 开头预览，完整版见[报告样例](docs/特征筛选报告样例.md) | ![特征探查报告样例](imgs/feature/06-特征探查报告样例.jpg) <br/> **特征探查报告** — 开头预览，完整版见[报告样例](docs/特征探查报告样例.md) |
